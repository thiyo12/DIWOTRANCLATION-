...
(function () {
  ...
  var DICT = {
    ...
    "fill.ratesNote": { en: "Plain CHF/word · Certified CHF/word — final quote by email.", de: "Einfach CHF/Wort · Beglaubigt CHF/Wort — Angebot per E-Mail.", ta: "எளிய CHF/சொல் · சான்று CHF/சொல் — இறுதி விலை மின்னஞ்சலில்." },
    ...
    "pay.cardNumber": { en: "Card number", de: "Kartennummer", ta: "அட்டை எண்" },
    "pay.expiry": { en: "Expiry", de: "Gültig", ta: "காலாவதி" },
    ...
    "fee.minNote": { en: "Minimum CHF 25 per document. Certified translations include the interpreter's declaration of accuracy. Exact quotes within one working day.", de: "Mindestens CHF 25 pro Dokument. Beglaubigte Übersetzungen inklusive Erklärung. Angebot innerhalb eines Arbeitstags.", ta: "ஒவ்வொரு ஆவணத்திற்கும் குறைந்தபட்சம் CHF 25." },
